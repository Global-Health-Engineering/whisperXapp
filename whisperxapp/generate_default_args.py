"""
Readapted code from https://github.com/m-bain/whisperX/blob/main/whisperx/__main__.py to generate WhisperX default args.
This is the code to update if new parameters are added in WhisperX
"""
